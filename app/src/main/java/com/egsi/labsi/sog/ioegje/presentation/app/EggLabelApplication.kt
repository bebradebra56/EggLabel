package com.egsi.labsi.sog.ioegje.presentation.app
...
private const val EGG_LABEL_APP_DEV = "SwQQ9mRsYw6qgvyY7kKg4C"
...
class EggLabelApplication : Application() {
    ...
    override fun onCreate() {
        ...
        appsflyer.init(
            ...
            object : AppsFlyerConversionListener {
                    ...
                    if (afStatus == "Organic") {
                        CoroutineScope(Dispatchers.IO).launch {
                            try {
                                ...
                                Log.d(EGG_LABEL_MAIN_TAG, "Error: ${d.message}")
                                eggLabelResume(EggLabelAppsFlyerState.EggLabelError)
                            }
                        }
                    } else {
                ...
                override fun onAppOpenAttribution(p0: MutableMap<String, String>?) {
                    Log.d(EGG_LABEL_MAIN_TAG, "onAppOpenAttribution")
                }

                override fun onAttributionFailure(p0: String?) {
                    Log.d(EGG_LABEL_MAIN_TAG, "onAttributionFailure: $p0")
                }
            },
            this
        )
        ...
        appsflyer.start(this, EGG_LABEL_APP_DEV, object :
            ...
            override fun onSuccess() {
                Log.d(EGG_LABEL_MAIN_TAG, "AppsFlyer started")
            }
        ...
        startKoin {
            ...
            androidContext(this@EggLabelApplication)
            modules(
                listOf(
                    eggLabelModule
                )
    ...
    private fun eggLabelGetAppsflyerId(): String {
        ...
        Log.d(EGG_LABEL_MAIN_TAG, "AppsFlyer: AppsFlyer Id = $appsflyrid")
        return appsflyrid
    }
    ...
    companion object {
        ...
        const val EGG_LABEL_MAIN_TAG = "EggLabelMainTag"
    }
}